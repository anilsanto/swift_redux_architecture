...
typealias AppMiddleware<State: StateType> = (Action, MiddlewareContext<State>) -> Action?
...
func createMiddleware<State: StateType>(_ middleware: @escaping AppMiddleware<State>) -> ReSwift.Middleware<State> {
